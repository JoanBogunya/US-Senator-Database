...
function createtable() {
    ...
    for (i = 0; i < obj.length; i++) {
        if (obj[i].state == pstate || pstate == 'All') {
            if (obj[i].party == 'R' && party.includes('R') || obj[i].party == 'D' && party.includes('D') || obj[i].party == 'I' && party.includes('I')
                || !party.includes("R") && !party.includes("D") && !party.includes("I")) {
...
document.getElementById("independent").addEventListener("click", parties);
